...
public class GameRenderer {
    ...
    private static final float TITLE_BAR_H = 330f; // タイトル下部のメニュー操作バー高さ（不透明・Task 160→185→188→182 で 200→250→290→330 に拡張）
    ...
    public void renderTitle(int selection, Stage backdrop, boolean replayAvailable) {
        ...
        drawCentered((selection == 5 ? "> " : "  ") + "VIEWER" + (selection == 5 ? " <" : ""),
        ...
        drawCentered("SURVIVAL = HP carry  |  TIME ATTACK = 60s  |  KEY CONFIG = remap  |  VIEWER = sprite anim  |  REPLAY LAST = watch last",
