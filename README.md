...
| タイトルで **VERSUS / TRAINING** を選択（通常起動はここから） | 全 20 キャラから P1 / P2 を選択 |

| ステージ選択 | 対戦画面 |
|---|---|
| ![ステージ選択](docs/screenshots/128-stageselect.png) | ![対戦画面](docs/screenshots/129-pixel-sprites.png) |
| 全 10 ステージから対戦の背景を選んでバトル開始 | レトロ・ドット絵調のキャラ・HP / 必殺技ゲージ / 勝利ドット・命中演出（攻撃／のけぞり） |

| パーフェクト KO | |
|---|---|
| ![パーフェクト KO](docs/screenshots/127-perfect.png) | |
| ノーダメージでラウンドを取ると金色 **PERFECT!** 演出 | |
