...
| ステージ選択 | 対戦画面 |
|---|---|
| ![ステージ選択](docs/screenshots/128-stageselect.png) | ![対戦画面](docs/screenshots/67-fighter008-roster.png) |
| 全 10 ステージから対戦の背景を選んでバトル開始 | HP / 必殺技ゲージ / 勝利ドット / ステージ名つきの対戦画面（スプライト描画） |
