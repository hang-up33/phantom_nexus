...
| 181 | バトル一時停止：P キーで試合を一時停止／再開（タイムカウントも停止・リプレイ記録/再生中は無効）。ESC でもポーズメニュー（RESUME / RETURN TO TITLE）を表示・ゲームパッド対応・撮影/リプレイでは無効（後方互換） | ✅ 完了 |
| 182 | キャラクタービューア：タイトルに VIEWER を追加・全キャラのスプライトアニメをコマ送りで確認できる開発ツール画面 | ✅ 完了 |
